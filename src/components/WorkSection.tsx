        ...
        <section id="work" className="py-32 bg-[#050B14]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                    ...
                    <a href="#" className="hidden md:flex items-center gap-2 text-accent font-bold hover:tracking-wide transition-all">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {projects.map((project, index) => (
                        <motion.div
                            ...
                            className="group relative bg-white/5 rounded-3xl overflow-hidden border border-white/10 hover:border-accent/50 transition-all duration-300 hover:-translate-y-2"
                        >
                            {/* Card Content */}
